...
jQuery(function ($) {
    ...
    closeButton: '<a href="javascript:$.closeDialog();" class="nyroModalClose" id="closeBut" title="fechar">Fechar</a>', // Adding automaticly as the first child of #nyroModalWrapper
    ...
    contentError: 'N&#227;o foi poss&#237;vel efetuar a opera&#231;&#227;o.<br />Por favor tente novamente.<br /><a href="#" class="nyroModalClose">Fechar</a>', // Content placed in the loading div in case of error
...
function processModal(settings) {
    ...
    if (currentSettings.type == 'swf') {
        ...
        currentSettings.content = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="' + currentSettings.width + '" height="' + currentSettings.height + '"><param name="movie" value="' + url2 + '"></param>';
        var tmp = '';
        $.each(currentSettings.swf, function (name, val) {
            currentSettings.content += '<param name="' + name + '" value="' + val + '"></param>';
            tmp += ' ' + name + '="' + val + '"';
        });
        currentSettings.content += '<embed src="' + url2 + '" type="application/x-shockwave-flash" width="' + currentSettings.width + '" height="' + currentSettings.height + '"' + tmp + '></embed></object>';
    }
    ...
    if (from) {
        ...
        if (currentSettings.type == 'form') {
            ...
            $('iframe', modal.tmp).eq(0)
					...
					.load(function (e) {
					    if (currentSettings.titleFromIframe && url2.indexOf(window.location.hostname) > -1)
            ...
            initModal();
            modal.tmp.html('<iframe frameborder="0" hspace="0" src="' + url2 + '" name="nyroModalIframe" id="nyroModalIframe"></iframe>');
...
function initModal() {
    ...
    if (!modal.full) {
        ...
        //conteudo js somente para este projeto.
...
function fileType() {
    ...
    if (from && from.nodeName) {
        ...
        url2 = jFrom.attr(from.nodeName.toLowerCase() == 'form' ? 'action' : 'href');
        if (!url2)
            url2 = location.href.substring(window.location.host.length + 7);
        currentSettings.url = url2;
        ...
        var imgType = imageType(url2, from);
        if (imgType)
            return imgType;
        ...
        if (from.nodeName.toLowerCase() == 'form') {
            if (iframe)
                return 'iframeForm';
            setCurrentSettings(extractUrlSel(url2));
